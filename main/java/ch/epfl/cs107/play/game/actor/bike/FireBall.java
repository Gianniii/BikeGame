...
public class FireBall extends Trigger implements Actor {
	private final static String nomImage ="fireball.png";
	...
	public FireBall(ActorGame game, Vector position) {
	...
	public void update(float deltaTime) {
		...
		if (isHit()) {
			((BikeGame) getOwner()).updateLives(false);
			destroy(); 
		}
